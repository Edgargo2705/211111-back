...
const email_password = async (req, res) => {
    ...
    const url = `http://edgar.hopto.org/Reset_password?${token}&email=${email}`;
    console.log(email)
    await transporter.sendMail({
        from: '<211150@ids.upchiapas.edu.mx>', // sender address
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
                                                    ...
                                                    <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:30px;font-weight:bold;line-height:1;text-align:center;color:#555;">
                                                        Oops!
                                                    </div>
                                            ...
                                            <tr>
                                                <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
                                                    ...
                                                    If you did not make this request, simply ignore this email. Otherwise, click the button above to reset your password.
                                                    </div>
